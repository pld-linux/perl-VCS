...
VCS stanowi API dla abstrakcyjnego dostępu z kodu w Perlu do wszelkich
systemów kontroli wersji. Osiąga się to w podobny sposób, jak w
zestawie modułów DBI. Istnieją klasy "pojemników": VCS::Dir, VCS::File
i VCS::Version oraz klasy "implementacji", takie jak: VCS::Cvs::Dir,
VCS::Cvs::File i VCS::Cvs::Version, będące podklasami swoich
